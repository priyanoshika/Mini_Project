...
class travel:
    ...
    #Define Function
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Cantonment":
                    switch ={"Junction": 10,"RaceCourseRoad": 8,"BHEL":6,"Cantonment": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Junction":
                    switch ={"Junction": 0,"RaceCourseRoad": 2,"BHEL":5,"Cantonment": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "RaceCourseRoad":
                    switch ={"Junction": 2,"RaceCourseRoad": 0,"BHEL":3,"Cantonment": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "BHEL":
                    switch ={"Junction": 5,"RaceCourseRoad": 3,"BHEL":0,"Cantonment": 6}
                    Km.set(switch[varl2.get()])        
   ...
   #mainframe
        ...
        self.lblTitle=Label(Tops,font=('arial',70,'bold'),text=" Taxi Booking System ")
        self.lblTitle.grid()
    ...
    #Taxi Information
        ...
        self.cboPickup['value']=('','Cantonment','BHEL','RaceCourseRoad','Junction')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Junction','RaceCourseRoad','Cantonment','BHEL')
        self.cboDrop.current(0)
